...
\begin{rmq}
  ...
  \begin{itemize}
    ...
    \item \textbf{Hors Programme} On dit que la série entière converge simplement sur $D$ vers $f$ si il existe $f \in \bR^{D}$ telle que $f = \sum_{n=0}^{\infty} a_n x^n$
    \item \textbf{Hors Programme} On dit que la série entière converge absolument sur $D$ vers $f$ si il existe $f \in \bR^{D}$ telle que $f = \sum_{n=0}^{\infty} \abs{a_n x^n}$ 
  \end{itemize}
\end{rmq}
\subsection{Autre}
\begin{rmq}
